#ifndef ESCURECER_H_INCLUDED
#define ESCURECER_H_INCLUDED
#endif // ESCURECER_H_INCLUDED

#include <stdio.h>
#include <stdlib.h>

int** funcaoAlocarMatriz(int x, int y){
...
void Principal__Escurecer(){
    ...
    printf("Digite a porcentagem de Escurecimento da imagem:\n");
    scanf("%d",&e);
